...
namespace Xels.SmartContracts.CLR.Validation
{
    ...
    public class MethodParamValidator : IMethodDefinitionValidator
    {
        ...
        public static readonly IEnumerable<string> AllowedTypes = new[]
        {
            ...
            typeof(Stratis.SmartContracts.UInt128).FullName,
            typeof(Stratis.SmartContracts.UInt256).FullName,
            typeof(Stratis.SmartContracts.Address).FullName,
            typeof(byte[]).FullName
        };
        ...
        {
            return param.ParameterType.FullName == typeof(Stratis.SmartContracts.ISmartContractState).FullName;
        }
