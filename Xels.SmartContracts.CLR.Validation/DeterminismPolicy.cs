...
namespace Xels.SmartContracts.CLR.Validation
{
    ...
    public static class DeterminismPolicy
    {
        public static WhitelistPolicy WhitelistPolicy = new WhitelistPolicy()
            ...
            .Namespace(typeof(Stratis.SmartContracts.SmartContract).Namespace, AccessPolicy.Allowed, SmartContractsPolicy);
        ...
        {
            policy
                .Type(typeof(Stratis.SmartContracts.SmartContract), AccessPolicy.Allowed);
        }
    }
}