...
namespace SwapExtractionTool
{
    public sealed class VoteExtractionService : ExtractionBase
    {
        ...
        public VoteExtractionService(int xelsNetworkApiPort, Network straxNetwork, BlockExplorerClient blockExplorerClient) : base(xelsNetworkApiPort, straxNetwork)
        {
                    ...
                    foreach (In input in tx._in)
                    {
                        ...
                        if (this.collateralVotes.ContainsKey(input.hash))
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    AddressBalancesResult balance = await $"http://localhost:{this.XelsNetworkApiPort}/api"
