...
namespace Xels.External.Masternodes
{
    public sealed class RegistrationService
    {
        ...
        private const string nodeExecutable = "Xels.CirrusMinerD.exe";
        ...
        {
            this.rootDataDir = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "XelsNode");
