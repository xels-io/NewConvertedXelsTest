...
namespace Xels.Bitcoin.Features.MemoryPool.Tests.PoS
{
    /// <summary>
    /// Unit tests for the memory pool validator.
    /// </summary>
    public class XelsMempoolValidatorTest : TestBase
    {
        public XelsMempoolValidatorTest() : base(new StraxRegTest())
        {
        }
