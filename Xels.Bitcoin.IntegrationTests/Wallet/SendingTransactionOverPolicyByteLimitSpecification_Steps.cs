...
namespace Xels.Bitcoin.IntegrationTests.Wallet
{
    public partial class SendingTransactionOverPolicyByteLimit : BddSpecification
    {
        ...
        {
            this.firstNode.FullNode.NodeController<WalletController>().SendTransactionAsync(new SendTransactionRequest(this.transaction.ToHex(this.firstNode.FullNode.Network)));
        }
