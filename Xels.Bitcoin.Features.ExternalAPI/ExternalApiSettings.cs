...
namespace Xels.Bitcoin.Features.ExternalApi
{
    ...
    public class ExternalApiSettings
    {
        ...
        /// <summary>
        /// Url for retrieving Xels and Ethereum prices.
        /// </summary>
        ...
        public ExternalApiSettings(NodeSettings nodeSettings)
        {
            ...
            this.PriceUrl = nodeSettings.ConfigReader.GetOrDefault(PriceUrlKey, "https://api.coingecko.com/api/v3/simple/price?ids=xels,ethereum&vs_currencies=usd");
