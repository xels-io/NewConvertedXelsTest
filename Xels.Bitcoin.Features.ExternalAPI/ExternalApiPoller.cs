...
using Xels.Bitcoin.Features.ExternalApi.ApiClients;
...
namespace Xels.Bitcoin.Features.ExternalApi
{
    ...
    public class ExternalApiPoller : IExternalApiPoller
    {
        ...
        {
            return this.coinGeckoClient.GetXelsPrice();
        }
        ...
        public decimal EstimateConversionTransactionFee()
        {
            ...
            decimal xelsPriceUsd = this.GetXelsPrice();

            if (xelsPriceUsd == -1)
                return -1;

            return (overallGasUsd / xelsPriceUsd) + (ConversionTransactionFee / xelsPriceUsd);
        }
