...
namespace NBitcoin.Tests
{
    public class NetworkTests
    {
        ...
        public void StraxMainIsInitializedCorrectly()
        {
            ...
            Assert.Equal(StraxNetwork.XelsMaxTimeOffsetSeconds, network.MaxTimeOffsetSeconds);
            Assert.Equal(StraxNetwork.XelsDefaultMaxTipAgeInSeconds, network.MaxTipAge);
