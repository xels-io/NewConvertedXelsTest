...
namespace Xels.SmartContracts.CLR
{
    ...
    public class ReflectionVirtualMachine : IVirtualMachine
    {
        ...
        /// </summary>
        public VmExecutionResult ExecuteMethod(Stratis.SmartContracts.ISmartContractState contractState, ExecutionContext executionContext,
        ...
        internal void LogExecutionContext(Stratis.SmartContracts.IBlock block, Stratis.SmartContracts.IMessage message, uint160 contractAddress)
        {
