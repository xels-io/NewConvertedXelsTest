...
namespace Xels.SmartContracts.CLR
{
    ...
    {
        Stratis.SmartContracts.IBlock Block { get; }
        ...
        Stratis.SmartContracts.ISmartContractState CreateSmartContractState(IState state, RuntimeObserver.IGasMeter gasMeter, uint160 address, BaseMessage message, IStateRepository repository);
