...
namespace Xels.SmartContracts.CLR.Serialization
{
    ...
    public class Prefix
    {
        ...
        private Type GetType(byte b)
        {
            switch ((MethodParameterDataType)b)
            {
                case MethodParameterDataType.Address:
                    return typeof(Stratis.SmartContracts.Address);
                ...
                case MethodParameterDataType.UInt128:
                    return typeof(Stratis.SmartContracts.UInt128);
                case MethodParameterDataType.UInt256:
                    return typeof(Stratis.SmartContracts.UInt256);
                default:
        ...
        private static MethodParameterDataType GetPrimitiveType(Type o)
        {
            ...
            if (o == typeof(Stratis.SmartContracts.Address))
            ...
            if (o == typeof(Stratis.SmartContracts.UInt128))
                return MethodParameterDataType.UInt128;

            if (o == typeof(Stratis.SmartContracts.UInt256))
